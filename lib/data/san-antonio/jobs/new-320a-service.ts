...
export const job: Job = {
  ...
  materials: [
    { item: "320A Ringless Meter Socket", quantity: "1", spec: "Milbank U2448-X - 320A ringless lever-bypass meter socket, OH/UG, 4-jaw, single-phase - CPS Energy approved Class 320. Vendor: MIB (Elliott Electric Supply)", unitPrice: 612.55 },
