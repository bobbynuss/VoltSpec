...
import { PINE_BLUFF_OFFICIAL_DOCS } from "../pine-bluff/official-docs";

export const PINE_BLUFF_CONFIG: JurisdictionConfig = {
  id: "pine-bluff",
  ...
  textReplacements: [
    ...
    ["CPS", "Entergy"],
    ["City of San Antonio", "City of Pine Bluff"],
    ["Bexar County", "Jefferson County"],
  ],
  officialDocs: PINE_BLUFF_OFFICIAL_DOCS,
};
