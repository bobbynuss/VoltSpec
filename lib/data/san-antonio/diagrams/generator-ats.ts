export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 660" font-family="Arial, sans-serif">
  ...
  <text x="170" y="112" text-anchor="middle" fill="#94a3b8" font-size="9">Eaton BRSPT2ULTRA</text>
  ...
  <text x="170" y="190" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R</text>
