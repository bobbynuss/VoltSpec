...
const steps = [
  {
    ...
    body: "Use the Search bar at the top of the sidebar to quickly find any city or job type — just start typing. VoltSpec covers 74 jurisdictions across 14 states with 29 job types each. Filter by state, or pick from the dropdowns. Enter your ZIP code and the nearest Elliott branch auto-populates.",
  },
  {
    num: 2,
    tourIndex: 3,
    ...
    body: "Hit the big yellow Generate Full Package button. VoltSpec builds everything in one shot: NEC 2026 requirements, a complete bill of materials with Elliott Electric part numbers and vendor codes, a schematic blueprint, supplier contacts, and official docs — all customized for your jurisdiction's utility rules.",
  },
  {
    num: 3,
    tourIndex: 4,
    title: "Materials Tab — Panel Type & Pricing",
    icon: Lightbulb,
    color: "text-purple-400",
    bg: "bg-purple-400/10 border-purple-400/25 hover:border-purple-400/50",
    body: "Materials auto-group into sections: Gear, Panels & Breakers, Wire, Conduit, Devices & Lighting, Fittings, and Misc. Use the Panel Type selector to swap between Eaton CH, BR, Pow-R-Line, SPAN, or MBT combo. Toggle estimated pricing on/off. Every item has direct Elliott Product and Search links. Hit Copy Bulk Entry to paste into Elliott's order system.",
  },
  {
    num: 4,
    tourIndex: 5,
    ...
    body: "When logged in, a green Quote Request button appears. It opens a modal with your full BOM — vendor codes, part numbers, quantities — ready to email directly to your Elliott sales rep. The email auto-CCs the rep based on your profile settings.",
  },
  {
    num: 5,
    tourIndex: 6,
    ...
    body: "PDF Package generates a professional multi-page PDF with cover page, requirements, materials table, blueprint, and supplier info. Job Sheet is a one-page condensed version for the job site. Both include the toggleable estimated pricing column.",
  },
  {
    num: 6,
    tourIndex: 0,
    title: "Save Projects to the Cloud",
    icon: CloudUpload,
    color: "text-cyan-400",
    bg: "bg-cyan-400/10 border-cyan-400/25 hover:border-cyan-400/50",
    body: "Sign up (free) and your jobs save to the cloud. Click Save Job, give it a name, and re-open any saved project from the Projects panel in the top nav. Works across devices.",
  },
];
