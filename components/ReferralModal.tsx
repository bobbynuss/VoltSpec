...
export function ReferralModal({ open, onClose }: ReferralModalProps) {
  ...
  const shareText = code
    ? `Try VoltSpec Pro free for 30 days — the best electrical estimating tool out there.\n\nUse my code: ${code}\n\nSign up at: https://voltspec.online/pricing`
    : "";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[hsl(222,47%,10%)] border border-[hsl(217,33%,20%)] rounded-xl w-full max-w-sm mx-4 p-6 shadow-2xl">
        ...
        <p className="text-sm text-gray-400 mb-5 leading-relaxed">
          Give a colleague <strong className="text-white">30 days of VoltSpec Pro</strong> — free.
          You get {remaining ?? 2} referral code{remaining !== 1 ? "s" : ""} per month.
        </p>
        ...
        {!code ? (
          ...
          <div className="space-y-4">
            <div className="bg-[hsl(217,33%,13%)] border border-[hsl(217,33%,22%)] rounded-lg p-4 text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">30-day Pro trial · Expires in 30 days if unused</p>
            </div>
