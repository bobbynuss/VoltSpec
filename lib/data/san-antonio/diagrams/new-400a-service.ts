export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 650" font-family="Arial, sans-serif">
  ...
  <text x="170" y="46" text-anchor="middle" fill="#64748b" font-size="9">UTILITY DROP (CPS) - 4-wire service</text>
  ...
  <text x="170" y="132" text-anchor="middle" fill="#94a3b8" font-size="9">Milbank U2448-X - CPS Engineering Approval Req.</text>
  ...
  <text x="84" y="232" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R</text>
  ...
  <text x="256" y="232" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R</text>
  <!-- Two-column breaker layout -->
  ...
  <text x="258" y="612" fill="#64748b" font-size="9">Utility (CPS)</text>
