export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 660" font-family="Arial, sans-serif">
  ...
  <text x="170" y="186" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R</text>
  ...
  <text x="170" y="362" text-anchor="middle" fill="#94a3b8" font-size="9">100A subpanel - BRP24L125G</text>
  ...
  <!-- CPS notice - width=110, right edge at x=290, clear of green line at x=320 -->
  <rect x="180" y="414" width="110" height="36" rx="3" fill="#1e293b" stroke="#a855f7" stroke-width="1"/>
  <text x="235" y="432" text-anchor="middle" fill="#a855f7" font-size="8" font-weight="bold">CPS Interconnect</text>
  <text x="235" y="446" text-anchor="middle" fill="#64748b" font-size="7">Solar+storage NEC 706</text>

  <!-- Ground - outside right at x=320, fully clear of CPS box (ends x=290) -->
