export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 560" font-family="Arial, sans-serif">
  ...
  <!-- Utility drop -->
  <text x="170" y="46" text-anchor="middle" fill="#64748b" font-size="9">UTILITY DROP (CPS) - overhead or underground</text>
  ...
  <text x="170" y="168" text-anchor="middle" fill="#475569" font-size="7">CPS Energy seals meter — contractor installs socket only</text>
  ...
  <text x="198" y="530" fill="#64748b" font-size="9">Utility (CPS)</text>
