export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 680" font-family="Arial, sans-serif">
  ...
  <!-- Utility -->
  <text x="80" y="50" text-anchor="middle" fill="#64748b" font-size="9">UTILITY (CPS)</text>
  ...
  <text x="260" y="184" text-anchor="middle" fill="#475569" font-size="7">(if req'd by CPS)</text>
  ...
  <text x="86" y="346" text-anchor="middle" fill="#94a3b8" font-size="8">200A BR series</text>
  <!-- Breaker slots -->
