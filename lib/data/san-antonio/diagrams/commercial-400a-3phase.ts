export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 700" font-family="Arial, sans-serif">
  ...
  <!-- Utility -->
  <text x="170" y="46" text-anchor="middle" fill="#64748b" font-size="9">UTILITY 3Ø 4-WIRE 120/208V WYE (CPS ENERGY)</text>
  ...
  <text x="170" y="112" text-anchor="middle" fill="#94a3b8" font-size="9">400A class CT cabinet — CPS Energy approved</text>
  <text x="170" y="126" text-anchor="middle" fill="#64748b" font-size="8">750 kcmil AL XHHW-2 service conductors</text>
  <text x="170" y="140" text-anchor="middle" fill="#475569" font-size="7">Meter &amp; metering equipment furnished by CPS Energy (no cost)</text>
  ...
  <text x="200" y="236" fill="#64748b" font-size="7">3 in. Sch 40 PVC</text>
  ...
  <text x="258" y="634" fill="#64748b" font-size="9">Utility (CPS)</text>
