export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 650" font-family="Arial, sans-serif">
  ...
  <text x="170" y="46" text-anchor="middle" fill="#64748b" font-size="9">UTILITY DROP (CPS) - 3-wire 120/240V service</text>
  ...
  <text x="170" y="190" text-anchor="middle" fill="#475569" font-size="7">CPS Engineering approval may be required - load calc with permit</text>
  ...
  <text x="170" y="282" text-anchor="middle" fill="#94a3b8" font-size="9">Eaton BRP40B200R - 40-space BR PON</text>
  ...
  <text x="170" y="398" text-anchor="middle" fill="#475569" font-size="8">40 spaces - room for EV, future loads</text>
  ...
  <text x="258" y="610" fill="#64748b" font-size="9">Utility (CPS)</text>
