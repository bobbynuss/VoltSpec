export const diagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 660" font-family="Arial, sans-serif">
  ...
  <text x="170" y="154" text-anchor="middle" fill="#94a3b8" font-size="9">1009874ACH - 200A ringless, CPS approved</text>
  <text x="170" y="170" text-anchor="middle" fill="#64748b" font-size="8">5 ft AFF (center) per CPS spec</text>
  ...
  <text x="170" y="226" text-anchor="middle" fill="#f97316" font-size="11" font-weight="bold">BR FEED-THROUGH PANEL</text>
  <text x="170" y="242" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R - 200A BR main breaker</text>
  ...
  <text x="170" y="342" text-anchor="middle" fill="#94a3b8" font-size="9">BRP20B200R - BR series, plug-on neutral</text>
