  ...
  return (
    <View style={styles.footer} fixed>
      ...
      <View style={styles.footerBody}>
        <Text style={styles.footerBold}>VoltSpec - {clean(label)}</Text>
        <Text style={styles.footerText}>Reference Only - Not Engineering Advice</Text>
        <Text
    ...
    >
      <Page size="LETTER" style={ts.page}>
        ...
        <View style={ts.footer} fixed>
          ...
          <Text style={ts.footerText}>VoltSpec - {clean(job.label)} - {dateStr}</Text>
        </View>

        {/* Branding */}
        <View style={ts.branding} fixed>
          <Text style={ts.brandingText}>
            Generated by <Text style={ts.brandingLink}>VoltSpec</Text>
          </Text>
        </View>
      </Page>
    </Document>
